      ...
      <div className="mt-auto pt-4 pb-4 px-3 space-y-3 shrink-0">
        ...
        {user ? (
          ...
          <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-zinc-600">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-white/5 text-zinc-600 shrink-0">
              <Icon name="User" size={16} />
            </span>
            <div className="min-w-0 flex-1">
              <div className="text-sm font-semibold text-zinc-600">Loading...</div>
              <p className="text-3xs text-zinc-700 font-mono">身份识别中</p>
            </div>
          </div>
        )}
