# M30 — Design System & UI Architecture (Step-by-Step Implementation)
...
frontend/src/
├── app/
│   ├── layout.tsx             ← Global layout wrapper & Theme Provider
│   ├── globals.css            ← Fluid typography, CSS variables, base styles
│   └── (routes)/              ← All pages ultra-airy, single-column
│
├── components/
│   ├── layout/
│   │   ├── Topbar.tsx         ← Logo, Search, Mobile Hamburger trigger
│   │   ├── Sidebar.tsx        ← Desktop left navigation
│   │   └── MobileNav.tsx      ← Slide-out drawer
│   │
│   ├── ui/                    ← The Core Foundation
│   │   ├── Button.tsx         ← Pill-shaped (Futuristic) vs Boxy (Retro)
│   │   ├── Card.tsx           ← Floating/Shadow (Futuristic) vs Border (Retro)
│   │   ├── VerdictMeter.tsx   ← Lab temperature bar style
│   │   └── AnimatedIcons.tsx  ← 🔥 Fire (particle effect), ⚡ Challenge
│   │
│   └── theme/                 
│       └── ThemeSwitcher.tsx  ← Context toggle for Futuristic <-> Retro
│
└── lib/                       
    └── theme-context.tsx      ← React Context to manage active theme globally
```

---

## 💻 Step 1 — Local: Install Design Dependencies
...
## 💻 Step 2 — Typography & Next.js Head Setup

YoTop10 uses 4 specific fonts to define its hierarchy.
- **Monoton** — "Yo" in logo
- **Anton** — "Top10" in logo
- **Roboto** — Ultra-readable body text
- **Cascadia Mono** — Labels, metadata, technical elements
...
## 💻 Step 3 — The Global CSS Engine (`globals.css`)
...
## 💻 Step 4 — Implement Dual Navigation
...
## 💻 Step 5 — Core UI Component Library
...
## 💻 Step 6 — The Compose Form Architecture
...
## 💻 Step 8 — Custom Profile Sandbox Architecture (Spacehey Style)
...
- [ ] Clicking Fire 🔥 drops sparks on the screen via canvas-confetti.
